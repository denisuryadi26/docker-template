    ...
    socketEvents(){
        this.io.on('connection', (socket) => {
            ...
            */
            ...
            /**
            * get the approve's list
            */
            socket.on('approveList', async () => {
                const result = await helper.getApproveList();
                this.io.to(socket.id).emit('approveListRes', {
                    userConnected: false,
                    approveLists: result.approveList
                });
